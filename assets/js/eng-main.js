...
function get_offre($url,$that,e){
    ...
    $.ajax({
        ...
        success: function (data) {
           ...
           x.innerHTML = data;
           $("#poste_selected").html("<b>"+ x.querySelector('#title_eng').innerHTML + " - " + x.querySelector('#departement_eng').innerHTML+ "</b>");
           $("#poste_contrat").html(x.querySelector('#type_contract_eng').innerHTML + " - " + x.querySelector('#lieu_travail_eng').innerHTML);
         
           $("#entreprise").html(x.querySelector('#entreprise_eng').innerHTML);
           $("#poste").html(x.querySelector('#poste_eng').innerHTML);
           $("#profil").html(x.querySelector('#profil_eng').innerHTML);
           $("#selected_job").val(x.querySelector('#title_eng').innerHTML + " - " + x.querySelector('#offre_date').innerHTML );
