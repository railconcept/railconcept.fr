...
// source: https://github.com/somanchiu/Keyless-Google-Maps-API

var CROSproxyURL = 'https://corsproxy.io/?';

var gmapRetryCount = 0;
...
function gmapLoadAndFix(callbackName, language) {
    var args = '';
    ...
    sendRequestThroughCROSproxy('https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=' + callbackName + args, 
        (googleAPIjs) => {
